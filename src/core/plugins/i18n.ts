...
const messages = {
  vi: {
    ...
    url: "URL",
    status: "Trạng thái",
    createdUser: "Người dùng đã tạo",
    editUser: "Người dùng đã sửa",
    action: "Thao tác",
    index: "STT",
    ...
    strategy: "Chiến lược",
    fundCompany: "Tên công ty",
    foundedDate: "Ngày tạo",
    interestHole: "Lãi/Lỗ",
    amount: "Giá trị mua",
    quantity: "Số lượng",
    navShare: "Nav/Share",
    ...
    bankAcccountName: "Tên tài khoản ngân hàng",
    bankAcccountNumber: "Số tài khoản ngân hàng",
    buyMinmum: "Mua số lượng tối thiểu",
    tradingDate: "Ngày giao dịch",
    closingTime: "Thời gian kết thúc",
  },
  en: {
    home: "Home",
    dashboard: "Dashboard",
    ...
    buy: "Buy",
    sell: "Sell",
    commandType: "Order Type",
    pending: "Pending",
    fail: "Fail",
    commandStatus: "Order Status",
    ...
    bankName: "Bank name",
    bankAcccountName: "Bank account name",
    bankAcccountNumber: "Bank account number",
    buyMinmum: "Buy minmum amount",
    strategy: "Strategy",
    ...
    ownershipRegistration: "Ownership number",
