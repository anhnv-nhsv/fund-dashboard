    ...
    <div class="pb-8">
      ...
      <div>
        <div class="px-12">
          ...
          <div class="row px-4">
            <div class="col-6 d-flex align-items-center">
              <div class="fs-5" style="min-width: 200px">VSD trading code</div>
        ...
        <div class="px-12">
          ...
          <div class="row px-4">
            <div class="col-6 d-flex align-items-center">
              <div class="fs-5" style="min-width: 200px">Loại hình ĐKSH</div>
            ...
            <div class="">
              <div class="px-4 mt-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">039C0000001</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">VCAM-NH VABF</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">Buy</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  <div class="fs-5" style="min-width: 50%">Gross amount</div>
                  <span class="fs-5 transaction-right">1,000,000</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">986.35</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">0.05%</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  <div class="fs-5" style="min-width: 50%">Estimate fee</div>
                  <span class="fs-5 transaction-right">0.05%</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">0.0%</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  <div class="fs-5" style="min-width: 50%">Estimate tax</div>
                  <span class="fs-5 transaction-right"></span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
              ...
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">11,000.25</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">11,000,345,000.25</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  ...
                  <span class="fs-5 transaction-right">05/10/2023</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4">
                <div class="d-flex align-items-center">
                  <div class="fs-5" style="min-width: 50%">State</div>
                  <span class="fs-5 transaction-right">Thành công</span>
                </div>
              </div>
              <span class="line my-4"></span>
              <div class="px-4 pb-4">
                <div class="d-flex align-items-center">
                  <div class="fs-5" style="min-width: 50%">Payment state</div>
                  <span class="fs-5 transaction-right">Thành công</span>
                </div>
              </div>
            </div>
